...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT_all(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,    KC_0,    KC_MINS,  KC_EQL,  KC_BSLS,  KC_TILD,  \
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                          KC_SPC,                          KC_NO,   KC_RALT,  KC_NO, KC_RGUI,    KC_RCTL
  ),
  LAYOUT_all(
    ...
    _______, KC_VOLD, KC_VOLU, _______, _______,_______,_______,_______,_______,_______, KC_LEFT, KC_RGHT, _______,            _______, \
