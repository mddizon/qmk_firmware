...
#define LAYOUT_dactyl64_wrapper(...) LAYOUT(__VA_ARGS__)

#define QWERTY_4_dactyl64 KC_LCTL, MO(_LW), KC_SPC, KC_ENT, MO(_LW), KC_RALT

#define BLANK_4_dactyl64  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT_dactyl64_wrapper(
    QWERTY_1_12,
    QWERTY_2_12,
    QWERTY_3_12,
    QWERTY_4_DOX
