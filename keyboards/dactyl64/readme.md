# Corne Keyboard (dactyl64)

Also known (incorrectly) as the `HeliDox`. 

![dactyl64](https://user-images.githubusercontent.com/736191/40575636-6fba63a4-6123-11e8-9ca0-3f990f1f9f4c.jpg)

![dactyl64](https://user-images.githubusercontent.com/736191/40887871-0eead5dc-678a-11e8-9518-e3ad9e5d2bac.png)

A split keyboard with 3x6 vertically staggered keys and 3 thumb keys.

Keyboard Maintainer: [foostan](https://github.com/foostan/) [@foostan](https://twitter.com/foostan)  
Hardware Supported: dactyl64 PCB, Pro Micro  
Hardware Availability: [PCB & Case Data](https://github.com/foostan/dactyl64)

Make example for this keyboard (after setting up your build environment):

```sh
make dactyl64:default
```
...
```sh
make dactyl64:default RGB_MATRIX_SPLIT_RIGHT=yes
```
