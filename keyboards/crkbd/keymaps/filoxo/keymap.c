...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------|
     OPT_TAB, KC_A  , KC_S  , KC_D  , KC_F  , KC_G  ,                     KC_H  , KC_J  , KC_K  ,  KC_L ,KC_SCLN,KC_QUOT,\
  //|-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------|
  ...
  [_LOWER] = LAYOUT( \
  //,-----------------------------------------------.                   ,-----------------------------------------------.
     KC_GRV , KC_1  , KC_2  , KC_3  , RGB_TOG  ,RGB_MOD   ,                     KC_6  , KC_7  , KC_8  , KC_9  , KC_0  ,KC_DEL ,\
  //|-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------|
  ...
  [_RAISE] = LAYOUT( \
  //,-----------------------------------------------.                   ,-----------------------------------------------.
     KC_TILD,_______,_______,_______,_______,_______,                    _______,_______,_______,KC_MINS,KC_PLUS,_______,\
  //|-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------|
