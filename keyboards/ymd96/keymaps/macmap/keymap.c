...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DEFLT] = KEYMAP_CUSTOM(
    ...
    KC_LCTL, KC_LGUI,KC_LALT,                              KC_SPC,                        MO(_RAISE),      MO(_RAISE),KC_LEFT, KC_DOWN,         KC_RGHT,    KC_P0,       KC_PDOT  \
	),
	/* Layer 1, raise layer
	*  |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
	*  |      |      |      |      |      |      |      |      |      |      |      |      |      |             |      |      |      |      |
	...
	*/
    ...
    ______,  RGB_TOG, RGB_MOD, RGB_VAI, RGB_VAD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, ______,  KC_F22,  KC_F23,  KC_F24,  ______,           ______,  ______,  ______,  ______, \
    ______,  BL_TOGG, BL_STEP, ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,           ______,           ______,  ______,  ______,  ______, \
    ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  KC_VOLD,KC_VOLU, KC_MUTE,           ______,  KC_MPLY,          ______,  ______,  ______,  ______, \
    ______,  ______,  ______,                               ______,                           ______,  ______,  KC_MPRV, KC_MNXT, KC_MNXT, ______,  ______  \
	)
};
